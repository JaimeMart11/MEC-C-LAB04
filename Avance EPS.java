import java.util.*;
 ...
 class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.print("Nombre y apellidos del usuario (o 'fin' para terminar): ");
            ...
            System.out.print("Condición especial (E para embarazo, L para limitación motriz, N para ninguna): ");
        ...
        for (Paciente paciente : pacientes) {
            ...
            TimerTask task = new TimerTask() {
                public void run() {
                    System.out.println("Pasa el turno" + paciente.getTurno());
                }
            };
...
class Paciente {
    ...
    public boolean tienePrioridad() {
        return edad < 12 || edad >= 60 || afiliacion.equals("PC") || condicionEspecial.equals("E") || condicionEspecial.equals("L");
    }
}